...
class GoblinDesktop:
    def __init__(self):
        ...
        ttk.Label(self.root, text="Goblin is running", font=("Segoe UI", 14, "bold")).pack(pady=(18, 4))
        ttk.Label(self.root, text="Highlight text and press Ctrl+Shift+Y or Ctrl+Alt+Y.").pack()
        ttk.Button(self.root, text="Search manually", command=self.show_search_box).pack(pady=12)
    ...
    def register_hotkeys(self):
        ...
        for shortcut in ("ctrl+shift+y", "ctrl+alt+y"):
            try:
                self.keyboard.add_hotkey(shortcut, callback)
            except Exception:
                pass
